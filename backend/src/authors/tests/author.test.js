...
const { deleteAuthorById, addAuthor } = require('../queries');
...
const credentialForRegisterAuthor2 = {
  firstName: 'Author2',
...
describe('Authors CRUD', () => {
  ...
  it('should get all authors on /api/authors', async () => {
  ...
  it('should get author on /api/authors/:id', async () => {
    await TestUtil.checkGettingResource(
      {
  ...
  it('should create new author on /api/author', async () => {
    await TestUtil.checkPostingResource(
      {
        url: '/api/authors',
        method: 'post',
        body: {
          ...credentialForRegisterAuthor2,
        },
        headers: {
          accessToken: token.accessToken,
          refreshToken: token.refreshToken,
  ...
  it('should change author profile on /api/author', async () => {
    await TestUtil.checkPostingResource(
      {
        url: '/api/authors',
        method: 'put',
  ...
  it('should delete author on /api/author', async () => {
    await TestUtil.checkPostingResource(
      {
        url: '/api/authors',
        method: 'delete',

...
const credentialForChangingProfile = {
  email: 'siusarnasite@gmail.com',
  firstName: 'newTest',
...
describe('User profile', () => {
  ...
  it('should get profile on /api/accounts/profile', async () => {
  ...
  it('should set profile on /api/accounts/profile', async () => {
    await TestUtil.checkPostingResource(
      {
        url: '/api/accounts/profile',
        method: 'put',
        body: credentialForChangingProfile,
        headers: {
          accessToken: token.accessToken,
          refreshToken: token.refreshToken,
        },
  ...
  it('should produce error (confirmPassword isn\'t equal password) on /api/accounts/changePassword', async () => {
    await TestUtil.checkPostingResource(
      {
        url: '/api/accounts/changePassword',
        method: 'put',
        body: {
          currentPassword: '1234567a',
          newPassword: '12345678b',
          confirmNewPassword: '12345678f',
        },
        headers: {
          accessToken: token.accessToken,
          refreshToken: token.refreshToken,
